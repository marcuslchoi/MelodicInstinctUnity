...
// UnityEngine.RuntimeAnimatorController[]
struct RuntimeAnimatorControllerU5BU5D_t971953881  : public Il2CppArray
{
public:
	ALIGN_TYPE (8) RuntimeAnimatorController_t3860414472 * m_Items[1];

public:
	inline RuntimeAnimatorController_t3860414472 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline RuntimeAnimatorController_t3860414472 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, RuntimeAnimatorController_t3860414472 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
